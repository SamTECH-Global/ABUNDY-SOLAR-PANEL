...
class allClass{
	function _header_div(){?>

        <header class="animated fadeInDown animated animated">
            <a href=""><div class="logo-div"><img src="img/logo.png" alt="logo"></div></a>
            <div id="menu-div" title="Menu" onclick="_open_menu('list-nav-div','120')"><i class="fa fa-th-list" ></i></div>
            <ul>
                <li class="active" title="Home" onclick="location.href=''">Home</li>
                <li title="Why Solar Power" onclick="scrolltodiv('why-solar-power','120')">Why Solar Power</li>
                <li title="Solar Panel" onclick="scrolltodiv('solar-panel','120')">Solar Panel</li>
            </ul>
        </header>

    <?php }

    function _unique_solar_solution_div(){?>

        <div class="other-content-div">
            <div class="title-div"><h1 data-aos="zoom-in" data-aos-duration="1000">- UNIQUE SOLAR SOLUTION -</h1></div>

            <div class="segment-div" >
                    <div class="content-pix" data-aos="slide-right" data-aos-duration="2000">
                        <img src="img/content-pix-1.jpg" alt="content-pix">
                    </div>
                    <div class="mini-pix" data-aos="slide-up" data-aos-duration="2000">
                        <img src="img/mini-pix-2.jpg" alt="mini-pix">
                    </div>
            </div>
            <div class="segment-div">
                    <div class="text-div" data-aos="zoom-in" data-aos-duration="1000">
                        <p>Abundy Inc. Canada is representing a Canadian company that has come up with a game changing solar offering.  
                        The newly patented system incorporates battery and inverter within solar panels.
                        <br><br>This permits an increase in efficiency and a reduction in cost.  
                        There is also a dramatic 75% reduction in cost and time of installation.
                        </p>
                    </div>
            </div>
        </div>
    <?php }
    function _solar_panel(){?>

        <div class="other-content-div" id="solar-panel">
            <div class="segment-div solar-container-div">
                <div class="div-in">
                    <div class="title-div"><h1 style="color:#fff; text-shadow:#000 0px 2px 4px;">- SOLAR PANEL -</h1></div>
                        <div class="content-pix solar-content-pix" data-aos="slide-up" data-aos-duration="1000">
                            <img src="img/content-pix-1.jpg" alt="content-pix">
                        </div>
                        <div class="content-pix solar-content-pix" data-aos="slide-up" data-aos-duration="1000">
                            <img src="img/content-pix-3.webp" alt="content-pix">
                        </div>     
                        <div class="content-pix solar-content-pix" data-aos="slide-up" data-aos-duration="1000">
                            <img src="img/content-pix-2.jpg" alt="content-pix">
                        </div>                       
                     </div>
                 </div>
            </div>
    ...
    <?php }
     function _smart_solution_div(){?>

        <div class="other-content-div">
            <div class="title-div"><h1 data-aos="zoom-in" data-aos-duration="1000">- SMART SOLUTION -</h1></div>
            ...
            <div class="segment-div">
                    <div class="text-div">
                        <p data-aos="zoom-in" data-aos-duration="1000">Artificial intelligence and smart chip technology permit the energy management system to download 
                            energy at lower price and can be centrally controlled by a utility owner or individually 
                            controlled by a home owner on their smart phone.
                        <br><br>Maximum efficiency is noted between temperatures of -30C (-22F) to +70C (158F)
                         as the system has a wide operational range.   FCC and UL Certification is complete. 
                         Degradation testing is complete. 

                         <br><br>Each panel can have its energy storage tripled by including three batteries 
                         per panel instead of one if required. 
                    ...
                    <div class="segment-div unique-segment-div">
                            <div class="text-div" style="padding-top:10px; text-align:left;" data-aos="zoom-in" data-aos-duration="1000">
                                ...
                                <p style="margin-top:10px; font-size:17px;">Traditional electricity is sourced from fossil fuels such as coal and natural gas.
                                         When fossil fuels are burned to produce electricity, they permit harmful gases that are 
                                         the primary cause of air pollution and global climate change. Not only are fossil fuels bad
                                          for the environment, but they are also a finite resource.
                                </p>
                            </div>
                    </div>
                    <div class="segment-div unique-segment-div">
                            <div class="text-div" style="padding-top:10px; text-align:left;" data-aos="zoom-in" data-aos-duration="1000">
                                ...
                                can increase in a short period of time.
                                </p>
                            </div>
                    </div>
                    <div class="segment-div unique-segment-div">
                            <div class="text-div" style="padding-top:10px; text-align:left;" data-aos="zoom-in" data-aos-duration="1000">
                                ...
                                <p style="margin-top:10px; font-size:17px;">Coal and natural gas plants produce air and water pollution that is harmful to human health. 
                                        But replacing fossil fuels with renewable energy sources, such as solar power, can reduce premature mortality
                                         as well as overall health care costs.
                                </p>
                            </div>
                    </div>
        ...
        <div class="other-content-div">
            ...
            <div class="segment-div" style="height:440px;">
                    <div class="text-div" data-aos="zoom-in" data-aos-duration="1000">
                        ...
                        <br><br>Greater than 40% Weight Reduction
                         <br><br>- 25 years warranty. 
                        </p>
                    </div>
            </div>
        </div>
    <?php }
    function _reliability_div(){?>
